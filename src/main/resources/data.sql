...
insert into user_account (user_id, user_password, nickname, email, memo, created_at, created_by, modified_at,
                          modified_by)
values ('taei', 'asdf1234', 'Taei', 'taei@mail.com', 'I am Taei.', now(), 'taei', now(), 'taei')
;
...
values ('Quisque ut erat.',
       ...
       ('Integer non velit.',
        ...
        '#fuscia', 'Shae', 'Rhody', '2021-01-14 23:22:59',
        '2022-01-31 12:02:00'),
       ('Quisque id justo sit amet sapien dignissim vestibulum.',
       ...
       ('Donec quis orci eget orci vehicula condimentum.',
        ...
        null, 'Hana', 'Anabel', '2021-05-19 15:38:50',
        '2021-09-18 12:45:53'),
       ...
       ('Morbi quis tortor id nulla ultrices aliquet.',
        'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo. Aliquam quis turpis eget el/it sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.',
       ...
       ('Lorem ipsum dolor sit amet, consectetuer adipiscing elit.',
        ...
        '#teal', 'Miltie', 'Krissy', '2021-11-29 14:30:18',
        '2021-06-28 06:23:31'),
       ...
       ('Praesent blandit lacinia erat.',
        ...
        '#puce', 'Bancroft', 'Brittne', '2021-11-07 20:25:38',
        '2021-07-15 23:44:30'),
       ...
       ('Vivamus metus arcu, adipiscing molestie, hendrerit at, vulputate vitae, nisl.',
        ...
        '#red', 'Claire', 'Alyson', '2021-06-05 04:03:52',
        '2021-04-21 16:51:40'),
       ('Proin eu mi.',
       ...
       ('Nulla suscipit ligula in lacus.',
        ...
        null, 'Guthry', 'Darla', '2021-05-17 21:21:38',
        '2021-12-25 10:06:03'),
       ...
       ('Etiam justo.',
        'Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat. In congue. Etiam justo. Etiam pretium iaculis justo.',
        null, 'Honor', 'Fayina', '2021-05-14 16:02:48',
        '2022-01-07 21:17:52'),
       ('Pellentesque eget nunc.',
